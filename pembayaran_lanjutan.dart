...
class Bayar extends StatefulWidget {
  ...
  Bayar({required this.selectedItems});
  @override
...
class _BayarState extends State<Bayar> {
  ...
  Widget build(BuildContext context) {
    ...
    if (alamatProvider.alamatSelected == null) {
      alamatProvider.setAlamat(alamatProvider.alamatList[0], 0); // Tetapkan alamat default
    }
    ...
    double totalPesanan() {
      ...
      return subtotal + totalOngkir() + biayaAdministrasi - jumlahDiskon; // Hitung total
    }
    return Scaffold(
      appBar: AppBar(
            ...
            children: [
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => AlamatPage()), //perlu diubah ke halaman alamat pengiriman
                  );
                },
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height   : 10,),
                        Text("${alamat?.nama ?? ""} | ${alamat?.nohp}", style: TextStyle(
                          fontSize: 15
                        ),),
                        SizedBox(height: 10,),
                        Row(
              ...
              Row(
                children: [
                  Icon(Icons.fire_truck_outlined, color: Colors.lightBlueAccent,),
                  Text(
                    "Opsi Pengiriman",
                    style: TextStyle(
                      fontSize: 16,
                  ...
                  child: Column(
                    children: [
                      GestureDetector(
                        onTap: (){
                          setState(() {
                            Provider.of<PriorityProvider>(context, listen: false).setPriority(true);
                          });
                        },
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: isPriority ? Colors.orangeAccent : Colors.black ,
                                width: 2
                              ),
                            ),
                            child: Padding(
                      ...
                      GestureDetector(
                        onTap: (){
                          setState(() {
                            Provider.of<PriorityProvider>(context, listen: false).setPriority(false);
                          });
                        },
                        child: Container(
                          width: double.infinity,
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(5),
                            border: Border.all(
                                color: isPriority ? Colors.black : Colors.orangeAccent,
                                width: 2
                            ),
                          ),
                          child: Padding(
                              padding: EdgeInsets.only(left: 10, top: 25),
                              child: Text("Standar - 28 Menit",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16
                                ),)
                        ...
                        Row(
                          children: [
                            ...
                            Text(NumberFormat.currency(
                              ...
                              symbol: 'Rp. ',
                              decimalDigits: 0,
                            ).format(widget.selectedItems[i].harga * widget.selectedItems[i].itemCount),),
                          ],
                        ),
                      ],
                    ),
              ...
              Container(
                ...
                height: 50,
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Total Pesanan : ", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 15),),
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Promo()), //perlu diubah ke halaman alamat diskon
                  );
                },
                child: Container(
                  width: double.infinity,
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.discount_rounded, color: Colors.orange,),
                      Text("Kode Promo : "),
                      SizedBox(width: MediaQuery.of(context).size.width/6,),
                      Text("Gunakan/ masukkan kode", style: TextStyle(fontWeight: FontWeight.w300),),
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Metode()), //perlu diubah ke halaman alamat metode
                  );
                },
                child: Container(
                  width: double.infinity,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("Subtotal Pemesanan (${banyak(widget.selectedItems).toString()} menu)",
                  style: TextStyle(
                    fontWeight: FontWeight.w300,
                    fontSize: 13
                  ),),
                  Text(
                    ...
                    symbol: 'Rp. ',
                    decimalDigits: 0,
                  ).format(total(widget.selectedItems)),style: TextStyle(
                ...
                children: [
                  ...
                  Text(
                    NumberFormat.currency(
                      ...
                      symbol: 'Rp. ',
                      decimalDigits: 0,
                    ).format(jumlahDiskon),style: TextStyle(
                      fontWeight: FontWeight.w300, fontSize: 13
                  ),),
                ...
                children: [
                  ...
                  Text(
                    NumberFormat.currency(
                      ...
                      symbol: 'Rp. ',
                      decimalDigits: 0,
                    ).format(totalOngkir()),style: TextStyle(
                      fontWeight: FontWeight.w300, fontSize: 13
                  ),),
              ...
              Row(
                ...
                Text("Rp 2.000", style: TextStyle(fontWeight: FontWeight.w300, fontSize: 13,),)
                ],
              ),
              SizedBox(height: 10,),
              Row(
                ...
                children: [
                  ...
                  Text(
                    NumberFormat.currency(
                      ...
                      symbol: 'Rp. ',
                      decimalDigits: 0,
                    ).format(totalPesanan()),style: TextStyle(
      ...
      persistentFooterButtons: [
        Column(
          children: [
            ...
            // Text("Rp ${totalPesanan().toStringAsFixed(0)}", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16,),)
          ],
        ),
        Container(
          ...
          child: TextButton(
              onPressed: (){
                setState(() {
                  int duit = p1.uang;
                  int kurang = total(widget.selectedItems).toInt();
                  duit -= kurang;
                  p1.uang = duit;
